...
class RosterController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    {
        if (!$this->_table) {
            $this->_table = $this->getServiceLocator()->get('\Core\Table\RosterTable');
        }
        return $this->_table;
    }
    ...
    {
        $oTable = new \Core\Grid\RosterGrid($this->getServiceLocator(),$this->getPluginManager());
    ...
    {
        $oForm = new \Core\Form\RosterForm();//new \Core\Form\RosterForm($this->getServiceLocator());
        $oRequest = $this->getRequest();
        
        $oFiltre = new \Core\Filter\RosterFilter();
        $oForm->setInputFilter($oFiltre->getInputFilter());
        
        if ($oRequest->isPost()) {
            $oEntite = new \Core\Model\Roster();
