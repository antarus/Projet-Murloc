...
class IndexController extends AbstractActionController {
    ...
    public function changepasswordAction() {
        ...
        if (empty($pass) || empty($passConfirm) || empty($forgetkey)) {
            ...
            if ($this->_getServUsers()->setpwd(md5($pass), $forgetkey)) {
                ...
                $this->_getLogService()->log(LogService::INFO, "Demande de changement de mot de passe refusé. erreur bdd.", LogService::USER);
    ...
    public function pwdswapAction() {
        ...
        if (!isset($aResult['mail']) || empty($aResult['mail'])) {
            ...
            $this->_getLogService()->log(LogService::INFO, "Demande de changement de mot de passe refusé. mail VIDE.", LogService::USER);
            ...
            $this->flashMessenger()->setNamespace('err');
            $this->flashMessenger()->addMessage($this->_getServTranslator()
                            ->translate("Adresse Email non valide ."));
